        ...
        child: ElevatedButton.icon(
            ...
            style: ButtonStyle(
              ...
              backgroundColor: MaterialStateProperty.resolveWith(
                (states) => widget.options.color,
              ),
              foregroundColor: MaterialStateProperty.resolveWith(
                  (states) => widget.options.textStyle?.color),
              overlayColor: MaterialStateProperty.resolveWith(
                (states) => widget.options.splashColor,
              ),
              elevation: MaterialStateProperty.resolveWith(
                (states) => widget.options.elevation,
              ),
              textStyle: MaterialStateProperty.resolveWith(
                (states) => widget.options.textStyle!,
              ),
              enableFeedback: true,
            )),
      );
      ...
      child: ElevatedButton(
        ...
        style: ButtonStyle(
          ...
          padding: MaterialStateProperty.all<EdgeInsetsGeometry>(
              widget.options.padding ?? EdgeInsets.zero),
          textStyle:
              MaterialStateProperty.all<TextStyle>(widget.options.textStyle!),
        ),
        child: textWidget,
      ),
    );
